...
*/
define(['BitsStreamGenerator'], function(BitsStreamGenerator){
  var serialVersionUID = -817701723016583596;
  //IMPLEMENT INHERITANCE
  AbstractWell.prototype = Object.create(BitsStreamGenerator.BitsStreamGenerator.prototype);
  AbstractWell.prototype.constructor = AbstractWell;
  function AbstractWell(k, m1, m2, m3, seed){
    //superconstructor call
    BitsStreamGenerator.BitsStreamGenerator.call(this);
  ...
  AbstractWell.prototype.setSeed = function () {
    ...
    this.index = 0;
    BitsStreamGenerator.BitsStreamGenerator.prototype.clear.call(this);
  };
  return AbstractWell;
});
