...
define(['RealDistribution'], function(RealDistribution){


  AbstractRealDistribution.prototype = Object.create(RealDistribution.RealDistribution.prototype);
  ...
  AbstractRealDistribution.prototype.inverseCumulativeProbability = function(p){
    if (p < 0.0 || p > 1.0){
      ...
      console.log("AbstractRealDistribution ERROR: out of range in inversecumulativeprobability");
    }
    ...
    //FIXME FOR UNIVARIATEFUNCTION AND UTILS
