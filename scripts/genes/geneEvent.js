...
define(function(){
  /**
   * Build a new event object describing a Sungear event.
   * @param list (GeneList) - the list this event pertains to.
   * @param source (Object) - the object that generated the event.
   * @param type (int) - the type of event.
   */
  ...
  GeneEvent.prototype = {
     ...
     * @return the gene list this event pertains to (GeneList)
     */
     ...
     * @return the object that generated this event (Object)
     */
    getSource:function(){
      return this.source;
    },
     ...
     * @return an integer describing the event type, chosen from the public final static ints declared above (int)
     */
    getType:function(){
      return this.type;
    }
